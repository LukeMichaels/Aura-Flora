...
void loop()
{
    ...
    if (readingInProgress && currentMillis - readingStartTime >= readingDelay)
    {
        ...
        // else if (humanResistance < 95000)
        // {
        //     currentAnimation = 12;
        // }
        else if (humanResistance < 100000)
        {
            currentAnimation = 17; // Medium resistance - Neutral, calm, relaxed
        }
        ...
        // else if (humanResistance < 135000)
        // {
        //     currentAnimation = 17;
        // }
...
// swirly purple + Pink flower, with cascading green stem
void animationTwo()
{
